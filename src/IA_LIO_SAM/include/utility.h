...
public:
    ...
    // Feature extraction density parameters
    int maxCornerFeatures;
    int maxSurfaceFeatures;
    float featureExtractionRadius;

    // Large dataset safety parameters
    int maxMapPoints;
    int autoDownsampleThreshold;
    float safeVoxelLeafSize;
    ...
    ParamServer()
    {
        ...
        nh.param<int>("lio_sam/maxCornerFeatures", maxCornerFeatures, 1000);
        nh.param<int>("lio_sam/maxSurfaceFeatures", maxSurfaceFeatures, 10000);
        nh.param<float>("lio_sam/featureExtractionRadius", featureExtractionRadius, 0.5);

        nh.param<int>("lio_sam/maxMapPoints", maxMapPoints, 1000000);
        nh.param<int>("lio_sam/autoDownsampleThreshold", autoDownsampleThreshold, 100000);
        nh.param<float>("lio_sam/safeVoxelLeafSize", safeVoxelLeafSize, 0.2);
